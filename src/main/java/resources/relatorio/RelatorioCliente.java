...
public class RelatorioCliente implements Relatorios {
	...
	public void gerarCabecalho() {
		...
		paragraphLinhas.add(new Chunk("\n-----------------------------------------------------------------------",
				new com.lowagie.text.Font(com.lowagie.text.Font.TIMES_ROMAN, 14)));

		Paragraph pTitulo = new Paragraph();
		pTitulo.setAlignment(Element.ALIGN_CENTER);
		pTitulo.add(new Chunk("Informações do cliente: " + cliente.getNome().toUpperCase(),
				new com.lowagie.text.Font(com.lowagie.text.Font.TIMES_ROMAN, 16)));
	...
	public void gerarCorpo() {
		...
		infoCliente.add(new Chunk(
				"CPF: " + cliente.getCpf() + "\nE-mail: " + cliente.getEmail() + "\nTelefone: " + cliente.getTelefone(),
				new com.lowagie.text.Font(com.lowagie.text.Font.TIMES_ROMAN, 12)));
	...
	public void gerarRodape() {
		...
		paragraphRodaPe
				.add(new Chunk("Pousada do Sossego", new com.lowagie.text.Font(com.lowagie.text.Font.TIMES_ROMAN, 10)));
