...
public class ListarReservas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaReservaCliente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Cliente", "Inicio", "Final", "Hora", "Quarto", "Status", "Valor"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(jTable, javax.swing.GroupLayout.PREFERRED_SIZE, 563, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTable, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (tabelaReservaCliente.getSelectedRowCount() == 1) {
            ...
            String nome = "Reserva " + reserva.getCliente().getNome() + " " + time.getSecond() + ".pdf";
            RelatorioReservaEspecifica reservaEspecifica = new RelatorioReservaEspecifica(reserva.getCliente(), nome);
            try {
    ...
    private void preecherTabela() {
        ...
        model.setRowCount(0);
        for (int i = 0; i < listClienteReserva.size(); i++) {
            model.addRow(new Object[]{listClienteReserva.get(i).getCliente().getNome(),
                Conversor.conversorData(listClienteReserva.get(i).getDataInicial()),
                Conversor.conversorData(listClienteReserva.get(i).getDataFinal()),
                listClienteReserva.get(i).getHoraEntrada(),
                listClienteReserva.get(i).getQuarto(),
                listClienteReserva.get(i).getStatus(),
                listClienteReserva.get(i).getValorDiaria()});
        }
    }
