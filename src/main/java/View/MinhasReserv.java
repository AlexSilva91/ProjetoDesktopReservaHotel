...
public class MinhasReserv extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaReserva.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Entrada", "Saida", "Hora", "Quarto", "Status", "Valor"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MinhasReserv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void preecherTabela() {
        ...
        for (Reserva reserva : listaReserva) {
            model.addRow(new Object[]{
                reserva.getId(), Conversor.conversorData(reserva.getDataInicial()), Conversor.conversorData(reserva.getDataFinal()),
                reserva.getHoraEntrada(), reserva.getQuarto(), reserva.getStatus(), reserva.getValorDiaria()});
        }
    }
