...
public class ClienteView extends javax.swing.JFrame {
	...
	public void recebeCPF(Cliente cliente) {
		JOptionPane.showMessageDialog(null, "Seja Bem-Vindo,  " + cliente.getNome() + " !");
	...
	public void delogado() {
		JOptionPane.showMessageDialog(null, "Perfil Deletado!");
	}

	public void exibe() {
		String nome = this.getCliente().getNome();
	...
	private void initComponents() {
		...
		jMenuItem1.setIcon(
				new javax.swing.ImageIcon(getClass().getResource("/main/java/View/img/icons8-ponta-do-lápis-16.png"))); // NOI18N
		...
		jMenuItem2.setIcon(
				new javax.swing.ImageIcon(getClass().getResource("/main/java/View/img/icons8-excluir-18.png"))); // NOI18N
		...
		jMenuItem6.setIcon(
				new javax.swing.ImageIcon(getClass().getResource("/main/java/View/img/icons8-informações-20 (1).png"))); // NOI18N
		...
		jMenuItem4.setIcon(
				new javax.swing.ImageIcon(getClass().getResource("/main/java/View/img/icons8-reserva-20.png"))); // NOI18N
		...
		jMenuItem5
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/java/View/img/icon-reserva-20.png"))); // NOI18N
	...
	private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem2ActionPerformed
		DeletarPerfil deletarPerfil = new DeletarPerfil();
